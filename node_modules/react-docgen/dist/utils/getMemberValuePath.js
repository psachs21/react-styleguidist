...
function getMemberValuePath(componentDefinition, memberName) {
  if (!isSupportedDefinitionType(componentDefinition)) {
    throw new TypeError('Got unsupported definition type. Definition must either be an ' + 'ObjectExpression, ClassDeclaration or ClassExpression. Got "' + componentDefinition.node.type + '" instead.');
  }
